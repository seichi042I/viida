...
const Container = styled.div<TextWithSubmitProps>`
...
export default ({width="15em",height="2em",iconButtonProps={},...props}:TextWithSubmitProps) => {
  iconButtonProps['width'] = height
  iconButtonProps['height'] = height
  return (
      <Container width={width} height={height} {...props}>
          <TextInput type="text" />
          <ArrowUpButton {...iconButtonProps} />
      </Container>
  )
}
